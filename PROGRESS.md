...
| Bluepoint mmWave Licht (Lux/Anwesenheit/Timer/Bypass) | blueprints/automation/mmwave_light.yaml | automation | valide | neu; author + min_version 2024.10.0 (triggers/actions-Syntax) + Input-Beschreibungen ergänzt |
